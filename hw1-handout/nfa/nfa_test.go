...
func TestReachable(t *testing.T) {
	...
	tests := []struct {
		...
		// remaining test cases for starting at 0
		{"dagTransitions", 0, 3, []rune{'b'}, false},
		{"dagTransitions", 0, 1, []rune{'c'}, false},
		{"dagTransitions", 0, 2, []rune{'a', 'a'}, false},
		{"dagTransitions", 0, 2, []rune{'c'}, false},
		{"dagTransitions", 0, 2, []rune{'b'}, false},

		// remaining test cases for starting at not 0
		{"dagTransitions", 1, 3, []rune{'b'}, true},
		{"dagTransitions", 1, 0, []rune{'a'}, false},
		{"dagTransitions", 1, 1, nil, true},
		{"dagTransitions", 3, 1, []rune{'a'}, false},
		{"dagTransitions", 3, 1, []rune{'b'}, false},
		{"dagTransitions", 3, 1, []rune{'c'}, false},
		{"dagTransitions", 3, 1, []rune{'a', 'b'}, false},

		{"expTransitions", 0, 0, []rune{'a', 'b'}, true},
		{"expTransitions", 0, 0, []rune{'a', 'a'}, false},
		{"expTransitions", 0, 0, []rune{'a', 'b', 'a', 'b', 'a', 'b', 'a', 'b'}, true},
		{"expTransitions", 0, 0, nil, true},
		{"expTransitions", 0, 1, []rune{'b'}, false},
		{"expTransitions", 0, 2, []rune{'a'}, true},
		{"expTransitions", 0, 2, []rune{'b'}, true},
